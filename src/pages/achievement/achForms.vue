    ...
    <div class="table-list">
      <div class="table_title">
        ...
        <div style="display:flex" class="pp">
          <div>
            ...
            <span v-if="userInfo.cityId != 40">佣金支付费合计：{{achList.length>0?achList[0].commissionPayments:0}}元</span>
      ...
      >
        ...
        <el-table-column label="佣金支付费（元）">
          <template slot-scope="scope">{{userInfo.cityId != 40 ? scope.row.commissionPayment:0}}</template>
        </el-table-column>
