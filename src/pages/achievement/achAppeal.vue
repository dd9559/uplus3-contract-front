      ...
      <div class="data-list" v-loading="loading">
        ...
        >
          ...
          <el-table-column label="下一步审核人" min-width="100">
            <template slot-scope="scope">
              <p v-if="scope.row.achievementAppeals[0]">{{scope.row.achievementAppeals[0].nextAuditDepName?scope.row.achievementAppeals[0].nextAuditDepName+"-":""}}{{scope.row.achievementAppeals[0].nextAuditName}}</p>
              <p v-else>-</p>
              <el-button type="text"
