        ...
        >
          ...
          <el-table-column label="当前审核人" min-width="100">
            <template slot-scope="scope">
              ...
              <div v-else>-</div>           
              <el-button type="text"
                            v-if="(userInfo.user&&(scope.row.achievementAppeals[0].auditId===userInfo.user.empId||scope.row.achievementAppeals[0].preAuditId===userInfo.user.empId)) && scope.row.achievementAppeals[0].auditStatus.value ==0"
          ...
          <el-table-column label="下一个审核人" min-width="100">
            <template slot-scope="scope">
              ...
              <p v-else>-</p>
              <el-button type="text"
                            v-if="(userInfo.user&&(scope.row.achievementAppeals[0].auditId===userInfo.user.empId ||scope.row.achievementAppeals[0].nextAuditId===userInfo.user.empId))  && scope.row.achievementAppeals[0].auditStatus.value ==0 &&  scope.row.achievementAppeals[0].nextAuditId != 0"
