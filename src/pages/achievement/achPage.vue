        ...
        <div class="dialog1">
            <div v-loading="loading"
                ...
                <div class="ach-header">
                    ...
                    <h1 v-if="dialogType==3"
                        style="fontSize:20px;">业绩分成</h1>
                    ...
                    <div class="house-divide">
                        ...
                        <div class="house-right f_r"
                            ...
                            <el-button type="primary"
                                v-if="dialogType==0"
                                @click="houseRelativeMans('getExamineEmployees')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==1"
                                @click="houseRelativeMans('getEmployeesByEdit')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==2"
                                @click="houseRelativeMans('getBackExamineEmployees')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==3"
                                @click="houseRelativeMans('getFirstInput')">相关人员</el-button>
                            <el-button type="primary"
                                @click="addMansHouse">添加分配人</el-button>
                            <el-button type="primary"
                                @click="houseRecode">房源价格变更记录</el-button>
                        </div>
                    </div>
                            ...
                            <el-table-column label="分成比例(%)"
                                ...
                                <template slot-scope="scope">
                                    <el-input v-model="scope.row.ratio"
                                        placeholder="请输入"
                                        @input="filterHouseNumber(scope.row.ratio,scope.$index)"></el-input>
                                </template>
                            </el-table-column>
                ...
                <template slot-scope="scope">
                  ...
                  <el-input v-else v-model="hx" disabled></el-input>
                            ...
                            <el-table-column label="公共业绩"
                                width="280">
                                <template slot-scope="scope">
                                    <el-checkbox-group @change="text2(scope.row)"
                            ...
                            <el-table-column prop="manager"
                                ...
                                <template slot-scope="scope">
                                    <a class="delete"
                                        ...
                                        @click="deleteHouse(scope.$index,houseArr,scope.row.id)">删除</a>
                    ...
                    <div class="house-divide top20">
                        ...
                        <div class="house-right f_r"
                            ...
                            <el-button type="primary"
                                v-if="dialogType==0"
                                @click="clientRelativeMans('getExamineEmployees')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==1"
                                @click="clientRelativeMans('getEmployeesByEdit')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==2"
                                @click="clientRelativeMans('getBackExamineEmployees')">相关人员</el-button>
                            <el-button type="primary"
                                v-else-if="dialogType==3"
                                @click="clientRelativeMans('getFirstInput')">相关人员</el-button>
                            <el-button type="primary"
                                @click="addMansClient">添加分配人</el-button>
                            <el-button type="primary"
                                @click="ammanger">{{$route.query.version=='0'?'AM管理关系':'师徒管理关系'}}</el-button>
                        </div>
                    </div>
                        ...
                        <el-table :data="clientArr"
                            ...
                            <el-table-column label="分成比例(%)"
                                ...
                                <template slot-scope="scope">
                                    <el-input v-model="scope.row.ratio"
                                        placeholder="请输入"
                                        @input="filterClientNumber(scope.row.ratio,scope.$index)"></el-input>
                                </template>
                            </el-table-column>
                ...
                <template slot-scope="scope">
                  ...
                  <el-input v-else v-model="hx" disabled></el-input>
                            ...
                            <el-table-column label="公共业绩"
                                width="280">
                                <template slot-scope="scope">
                                    <el-checkbox-group @change="text3(scope.row)"
                                        v-model="scope.row.checkbox">
                                        <el-checkbox v-for="(item,index) in ['门店','公司','大区']"
                                            :key=index
                                            :label=index>{{item}}</el-checkbox>
                            ...
                            <el-table-column prop="manager"
                                ...
                                <template slot-scope="scope">
                                    <a class="delete"
                                        style="color:#478de3;text-decoration:underline;cursor:pointer;"
                                        @click="deleteClient(scope.$index,clientArr,scope.row.id)">删除</a>
                                </template>
                            </el-table-column>
                        </el-table>
                    </div>
                    ...
                    <template v-if="hasServiceAgent">
                        <div class="house-divide top20"
                            ...
                            <div class="house-right f_r">
                                <el-button type="primary"
                                    @click="addserviceAgents">添加分配人</el-button>
                            </div>
                        </div>
                        <div class="ach-divide-list"
                            v-if="contType==2||contType==3">
                            <el-table :data="serviceAgents"
                                ...
                                <el-table-column label="分成比例(%)"
                                    ...
                                    <template slot-scope="scope">
                                        <el-input v-model="scope.row.ratio"
                                            placeholder="请输入"
                                            @input="filterFeeNumber(scope.row.ratio,scope.$index)"></el-input>
                                    </template>
                                </el-table-column>
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-input v-else v-model="hx" disabled></el-input>
                                ...
                                <el-table-column label="公共业绩"
                                    width="280">
                                    <template slot-scope="scope">
                                        <el-checkbox-group @change="text4(scope.row)"
                                            v-model="scope.row.checkbox">
                                            <el-checkbox v-for="(item,index) in ['门店','公司','大区']"
                                                :key=index
                                                :label=index>{{item}}</el-checkbox>
                                ...
                                <el-table-column prop="manager"
                                    ...
                                    <template slot-scope="scope">
                                        <a class="delete"
                                            style="color:#478de3;text-decoration:underline;cursor:pointer;"
                                            @click="deletefee(scope.$index,serviceAgents,scope.row.id)">删除</a>
                                    </template>
                                </el-table-column>
                            </el-table>
                        </div>
                    ...
                    <div class="ach-divide-list"
                        ...
                        <el-table :data="shensuArr"
                            ...
                            <el-table-column label="申诉人">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.appealName&&scope.row.appealName.length>0">{{scope.row.appealDepName}}-{{scope.row.appealName}}</div>
                                    <div v-else>-</div>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="审核人">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.auditName&&scope.row.auditName.length>0">{{scope.row.auditDepName}}-{{scope.row.auditName}}</div>
                                    <div v-else>-</div>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="审核状态(时间)"
                                min-width="120">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.auditStatus">{{scope.row.auditStatus.label}} ({{scope.row.auditTime|formatTime(false)}})</div>
                                    <div v-else>-</div>
                                </template>
                            </el-table-column>
                    ...
                    <div class="ach-divide-list contRemark"
                        v-if="this.contRemarks">
                ...
                <div class="ach-footer"
                    ...
                    <div class="footer-btn-layout f_r">
                        <el-button type="primary"
                            ...
                            @click="rejectAch"
                            class="color-red"
                            id="savebtn3">驳回</el-button>
                        <el-button type="primary"
                            round
                            @click="passAch"
                            class="color-green"
                            id="savebtn">通过</el-button>
                    </div>
                </div>
            ...
            >保存</el-button>-->
                ...
                <div class="ach-footer"
                    ...
                    <p class="f_l"
                        style="width:300px;">
                        审核日期：
                        <el-date-picker v-model="examineDate"
                            type="datetime"
                            placeholder="选择日期"
                    ...
                    <el-dialog :visible.sync="showTips1"
                        ...
                        <div v-loading="loading3">
                            ...
                            <div class="dialog2-btn">
                                <el-button type="primary"
                                    round
                                    @click="showTips1 = false">取消</el-button>
                                <el-button type="primary"
                                    round
                                    @click="manSure(type)"
                                    v-dbClick>确定</el-button>
                            </div>
                        </div>
                    </el-dialog>
                </div>
            ...
            <el-dialog class="record-table-dialog"
                ...
                <el-table :data="recordData"
                    ...
                    <el-table-column label="成交价格误差（%）"
                        width="140">
                        <template slot-scope="scope">{{scope.row.PriceDifferential}}</template>
                    </el-table-column>
                        ...
                        if (res.data.status == 200) {
                            ...
                            if (type == 2 && status == 1) {
                                if (this.state2 === 1) {
                                    ...
                                    var paperBtn2 = document.getElementById(
                                        "savebtn2"
                                    );
            ...
            this.$ajax.get("/api/achievement/" + infoType, param).then(res => {
                if (res.status === 200) {
                    ...
                    if (
                        ...
                        JSON.parse(res.data.data.distributionAgreement).length >
                            0
                    ) {
                    ...
                    if (res.data.data.examineDate) {
                        ...
                        if (typeof _date === "number") {
                            this.examineDate = this.$tool.timeFormat(
                                _date,
                                false
                            );
                        } else {
        ...
        contractCode(val) {
            ...
            if (val) {
                ...
                if (this.dialogType == 0) {
                    ...
                    this.$ajax
                        .get("/api/achievement/getContAgents", param)
                        .then(res => {
                            let data = res.data;
                            if (data.status === 200) {
