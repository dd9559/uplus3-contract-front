      ...
      <div v-loading="loading" class="base-dialog">
        ...
        <div class="ach-body">
          ...
          <div class="ach-divide-list">
            <el-table :data="houseArr" class="sushen" style="width:100%">
              <!-- 角色类型 不可输入-->
          ...
          <div class="ach-divide-list" style="margin-bottom:20px">
            <el-table :data="shensuArr" style="width: 100%">
              ...
              <el-table-column label="审核状态(时间)" min-width="180">
                <template slot-scope="scope">
                  <div  v-for="item in scope.row.approvalDetailsList" :key="item.appealTime"
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <div v-if="scope.row.auditStatus&&scope.row.auditStatus.value==0&&auditIds==1&&false">
        ...
        >
          ...
          <div class="footer-btn-layout f_r">
            <el-button type="primary" round @click="rejectAch" class="color-red" id="savebtn3">驳回</el-button>
            <el-button type="primary" round @click="passAch" class="color-green" id="savebtn">通过</el-button>
          </div>
        </div>
