<template>
    <div class="layout"
        ...
        <ScreeningTop @propQueryFn="queryFn"
            ...
            <el-form :inline="true"
                ...
                <el-form-item label="关键字"
                    prop="search">
                    <el-tooltip content="合同编号/纸质合同编号/房源编号/客源编号/物业地址/业主/客户/房产证号/手机号/经纪人姓名"
                        placement="top">
                        <el-input class="w200"
                ...
                <el-form-item label="合同类型"
                    prop="contractType">
                    <el-select v-model="propForm.contractType"
                        class="width200"
          ...
          <el-select v-model="propForm.divideType" class="w120" :clearable="true">
            ...
            ></el-option>
                ...
                <el-form-item label="业绩状态"
                    prop="achType">
                    <el-select v-model="propForm.achType"
                        class="w120"
                        :clearable="true">
                        <el-option v-for="item in achStatuArr"
                            :key="item.value"
                            :label="item.value"
                            :value="item.key"></el-option>
                    </el-select>
                ...
                <el-form-item label="申诉状态"
                    prop="appealType">
                    <el-select v-model="propForm.appealType"
                        class="w120"
                        :clearable="true">
                        <el-option v-for="item in aplStatuArr"
                            :key="item.value"
                            :label="item.value"
                            :value="item.key"></el-option>
                    </el-select>
                ...
                <el-form-item label="签后审核状态"
                    prop="contractType">
                    <el-select v-model="propForm.afterSigningStatus"
                        class="w120"
                        :clearable="true">
                        <el-option v-for="item in dictionary['756']"
                            :key="item.value"
                            :label="item.value"
                ...
                <el-form-item label="合作方式"
                    prop="contractType">
                    <el-select v-model="propForm.joinMethods"
                        class="w120"
                        :clearable="true">
                ...
                <el-form-item label="收佣状态">
                    <el-select v-model="propForm.receiveAmountState"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option v-for="item in dictionary['13']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <el-form-item label="审核时间"
                    prop="dateMo"
                    class="mr">
                    <el-date-picker v-model="propForm.auditTime"
                        class="w330"
                        type="daterange"
                        range-separator="至"
                        value-format="yyyy-MM-dd"
                ...
                <el-form-item label="上传人">
                    <el-select v-model="propForm.uploadId"
                        filterable
                        remote
                        reserve-keyword
                        :clearable="true"
        ...
        <div class="data-layout">
            ...
            <div class="table-tool">
                ...
                <p>
                    <el-button class="f_r"
                        ...
                        v-if="power['sign-yj-rev-export'].state">导出
                    </el-button>
                </p>
            </div>
            <!-- 头部 end -->
            ...
            <div class="data-list"
                ...
                <el-table :data="selectAchList"
                        ...
                        <template slot-scope="scope">
                            ...
                            <p>
                                ...
                                <span class="blue"
                                    ...
                                    v-if="getUser.version===3">{{scope.row.houseinfoCode}}</span>
                            ...
                            <p>
                                ...
                                <span class="blue"
                                    ...
                                    v-if="getUser.version===3">{{scope.row.guestinfoCode}}</span>
                    ...
                    <el-table-column label="业绩状态"
                        min-width="80">
                        <template slot-scope="scope">
                            <p v-if="scope.row.achievementState==-1"
                                class="blue"
                                style="cursor:text">待提审</p>
                            <p v-if="scope.row.achievementState==0"
                                class="blue"
                                style="cursor:text">审核中</p>
                            <p v-if="scope.row.achievementState==1"
                                class="green">已通过</p>
                            <p v-if="scope.row.achievementState==2"
                                class="orange">已驳回</p>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="申诉状态"
                        min-width="80">
                        <template slot-scope="scope">
                            <p v-if="scope.row.appealStatus.value==-1"
                                class="blue"
                                style="cursor:text">未申诉</p>
                            <p v-if="scope.row.appealStatus.value==0"
                                class="blue"
                                style="cursor:text">已处理</p>
                            <p v-if="scope.row.appealStatus.value==1"
                                class="green">未处理</p>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="签后审核状态"
                        min-width="90">
                        <template slot-scope="scope">
                            <span v-if="scope.row.signinState&&scope.row.signinState.value!==2"
                                :class="[{'blue-txt':scope.row.signinState.value===-1},{'yellow-txt':scope.row.signinState.value===0},{'green-txt':scope.row.signinState.value===1}]">{{scope.row.signinState.label}}</span>
                            ...
                            <span class="red-txt"
                                v-else-if="scope.row.signinState&&scope.row.signinState.value===2&&scope.row.signinRemarks.length===0">{{scope.row.signinState.label}}</span>
                            <span v-else>-</span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="propertyAddr"
                        label="物业地址"
                        min-width="120">
                        <template slot-scope="scope">
                        ...
                        <template slot-scope="scope">
                            ...
                            <div v-else>
                                <div v-for="item in scope.row.distributions">
                                    <el-tooltip v-if="(item.level4+item.assignor).length>12"
                                        class="item"
                                        effect="dark"
                    ...
                    <el-table-column label="上传业绩分成协议时间"
                        min-width="90">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="成交总价（元）"
                        min-width="90"
                        prop="dealPrice"></el-table-column>
                    <el-table-column label="实收/应收"
                        min-width="90">
                        <template slot-scope="scope">
                            <p>{{scope.row.receivedCommission+'/'+scope.row.receivableCommission}}</p>
                        </template>
                    </el-table-column>
                    <el-table-column label="交易服务费（元）"
                        min-width="90">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="交易服务费佣金（元）"
                        min-width="90">
                        <template slot-scope="scope">
                    ...
                    <el-table-column min-width="90">
                        <template slot="header"
                            slot-scope="scope">
                            应收分成金额（元）
                            <el-tooltip content="应收分成金额=个人应收佣金-平台费（未减去收款手续费）"
                                placement="top">
                    ...
                    <el-table-column label="当前审核人"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button type="text"
                                ...
                                v-if="((userInfo&&userInfo.empId==scope.row.preAuditId)||scope.row.auditId===userInfo.empId)&&scope.row.achievementState==0">{{userInfo&&userInfo.empId===scope.row.auditId?'转交审核人':'设置审核人'}}
                            </el-button>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="下一步审核人"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button type="text"
                                ...
                                v-if="(userInfo&&scope.row.auditId===userInfo.empId&&(scope.row.nextAuditId!==0))&&scope.row.achievementState==0">设置审核人
                            </el-button>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.isModify==0">
                                <div v-if="scope.row.achievementState==-1"
                                    class="check-btn">
                                    <span @click.stop="editAch(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-edit'].state">确认业绩</span><span @click.stop="shenSu(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-appeal'].state">申诉</span>
                                </div>

                                <div v-if="scope.row.achievementState==1"
                                    class="check-btn">
                                    <span @click.stop="againCheck(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-fs'].state&&userInfo">反审核</span><span @click.stop="shenSu(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-appeal'].state">申诉</span>
                                </div>

                                <div v-if="scope.row.achievementState==2"
                                    class="check-btn">
                                    <span @click.stop="editAch(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-edit'].state">确认业绩</span><span @click.stop="shenSu(scope.row,scope.$index)"
                                ...
                                <div v-if="scope.row.achievementState==0"
                                    class="check-btn">
                                    <span @click.stop="chehui(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-retreat'].state">撤回</span><span @click.stop="shenSu(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="power['sign-yj-rev-appeal'].state">申诉</span><span @click.stop="checkAch(scope.row,scope.$index)"
                                        style="cursor:pointer;"
                                        v-if="userInfo&&userInfo.empId===scope.row.auditId||scope.row.validateGrabAuth">审核</span>
                                    <div style="color:red"
            ...
            <el-dialog :title="'操作-'+smallTips"
                ...
                <span slot="footer"
                    ...
                    <el-button type="primary"
                        @click="changeStatus"
                        v-dbClick>确 定</el-button>
                </span>
            </el-dialog>
        </div>
        <!-- 申诉弹窗 -->
        <el-dialog :closeOnClickModal="$tool.closeOnClickModal"
            @close="close2"
            width="1000px"
            height="450px"
            class="ssdialog"
            ...
            <div class="ssu">
                ...
                <p style="width:300px"
                    v-if="userInfo">申诉人：{{userInfo.name}}</p>
            </div>
            <div class="role">
                <span class="point jianju">申诉角色：</span>
                <el-select v-model="SSuForm.role"
                    placeholder="请选择"
                    multiple
                    class="width300"
            ...
            <div class="role">
                <span class="point jianju"
                    style="margin-right:25px;">审核人：</span>{{depName}}
                <el-select v-model="SSuForm.empNames"
                    style="margin-left:22px;width:210px"
                    filterable
                    placeholder="请选择"
                    @change="getName">
                    <el-option v-for="item in this.empNames"
                        :key="item.empId"
                        :label="item.name"
                        :value="item.empId"></el-option>
                </el-select>
            ...
            <div class="input-group"
                ...
                <span class="point jianju"
                    style="min-width:78px">申诉内容：</span>
            ...
            <div class="input-group"
                ...
                <div>
                    ...
                    <div class="sustip"
                        v-show="SSuForm.pinzheng&&SSuForm.pinzheng.length!=0">
                        <!-- {{this.SSuForm.pinzheng}} -->
                        <span style="margin-right:20px"
                            v-for="(item,index) in SSuForm.pinzheng">
                            <span class="closepre">
                                <span class="link"
                                    slot="reference"
        ...
        <checkPerson :show="checkPerson.state"
            ...
            :page="checkPerson.page"></checkPerson>
        ...
        this.$nextTick(() => {
            ...
            if (res && res.route === this.$route.path) {
                ...
                if (this.propForm.contractType[0] != "") {
                    for (
                        let i = 0;
                        i < this.propForm.contractType.length;
                        i++
                    ) {
...
.layout {
    ...
    .filter-layout {
        ...
        .btn {
            ...
            margin-left: -28px;
            z-index: 9;
            background: url(../../assets/img/icon-dowm.png) no-repeat center
                center;
