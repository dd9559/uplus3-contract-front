<template>
  <div class="layout" style="background-color: #f5f5f5" ref="tableComView">
        ...
        >
          ...
          <el-table-column label="当前审核人" min-width="120">
            <template slot-scope="scope">
              ...
              >{{userInfo&&userInfo.empId===scope.row.auditId?'转交审核人':'设置审核人'}}
              </el-button>
            </template>
          </el-table-column>
    ...
    <!-- 申诉弹窗 -->
    <el-dialog :closeOnClickModal="$tool.closeOnClickModal" @close="close2" width="1000px" height="450px"
               class="ssdialog" title="申诉" :visible.sync="isSS">
      <div class="ssu">
      ...
      <div class="input-group" style="align-items: normal;position:relative">
        ...
        <el-input type="textarea" :rows="4" resize='none' v-model="SSuForm.remark" placeholder="无备注内容"
      ...
      <div class="input-group" style="align-items: normal">
        ...
        <div>
          <fileUp @getUrl='getAdd' :scane="uploadScane" :more=true :rules="mbrules" id='pinzheng' class='fileup'>选择文件
          </fileUp>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="submitForm" type="primary" size="small" round class="paper-btn paper-btn-blue" v-dbClick>确
          定
        </el-button>
      </div>
    </el-dialog>
