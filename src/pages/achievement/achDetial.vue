<template>
  <div>
    ...
    <div class="ach-body">
      ...
      <p
        class="f_l delive"
        style="position:relative;color:red;top:-14px"
      >房客源可分配业绩总计：{{comm?comm:0}}元</p>
      <div class="ach-divide-list">
        <el-table :data="houseArr" style="width: 100%" border>
          ...
          <!-- amaldar -->
          <el-table-column prop="amaldar" label="总监" :formatter="nullFormatter"></el-table-column>

          <!-- manager -->
          <el-table-column prop="manager" label="副总" :formatter="nullFormatter"></el-table-column>
      ...
      <template v-if="hasServiceAgent">
        <h1 class="f14" v-if="contType==2||contType==3">交易服务费佣金分成</h1>
        <p class="f14" v-if="contType==2||contType==3" style="color:red">
          交易服务费佣金可分配业绩：
          <span>{{tradeFee}}元</span>
        </p>
        <div class="ach-divide-list" v-if="contType==2||contType==3">
          <el-table :data="serviceach" style="width: 100%" border>
            <!-- roleType 分成人角色类型 :
                房源>0:录入、1:维护、2:独家、3:房勘、4:钥匙、5:委托、6:建盘
            客源>7:主客方、8:推荐人、9:签约人、10:A/M、11:协议方、12:协议方2-->
            <el-table-column label="角色类型">
      ...
      <div class="ach-check-list">
        <el-table :data="checkArr" key="tab11" border>
          ...
          <!-- auditorDepartment -->
          <el-table-column prop="auditor" label="姓名"></el-table-column>
          <!-- auditor -->
          <el-table-column prop="auditorDepartment" label="职务"></el-table-column>

          <el-table-column prop="createDepName" label="操作"></el-table-column>
      ...
      <div class="ach-divide-list">
        <el-table key="tab12" :data="shensuArr" class="sushen" style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    pass(operation = "yes") {
      ...
      let url =
        operation === "yes" ? "/appeal/appealAdopt" : "/appeal/appealReject";
      this.$ajax
