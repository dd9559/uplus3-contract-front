        ...
        <li v-if="activeItem==='收款信息'">
          ...
          <el-table border :data="!billMsg.inAccount?[{}]:billMsg.inAccount" header-row-class-name="theader-bg" :span-method="collapseRow" v-if="billMsg.inAccount||!billMsg.inAccount">
            ...
            <el-table-column align="center" label="操作">
              <template slot-scope="scope">
                <el-button type="text" @click="getPaper('create')" v-if="btnBill&&billMsg.billStatus&&billMsg.isDel===1&&(billMsg.billStatus.value===1||billMsg.billStatus.value===4)&&scope.row.payStatusValue!==4">开票</el-button>
                <span v-else>--</span>
              </template>
            </el-table-column>
          </el-table>
