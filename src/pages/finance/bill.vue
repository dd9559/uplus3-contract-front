<template>
    <div class="view"
        ref="tableComView">
        <ScreeningTop @propResetFormFn="reset"
            @propQueryFn="getData('search')">
            <div class="content">
                <div class="input-group">
                    <label>关键字:</label>
                    <el-tooltip content="合同编号/纸质合同编号/房源编号/客源编号/物业地址/业主/客户/手机号/收付ID"
                        placement="top">
                        <el-input class="w200"
                            :clearable="true"
                            size="small"
                ...
                <div class="input-group">
                    ...
                    <div class="time-picker">
                        <el-select :clearable="true"
                            ...
                            placeholder="请选择">
                            <el-option v-for="item in $tool.dropdown.dateType_money"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value">
                            </el-option>
              ...
              <el-tree :data="DepList" :props="defaultProps" @node-click="depHandleClick"></el-tree>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['56']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['32']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['23']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in drop_MoneyType"
                            :key="item.id"
                            :label="item.name"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['24']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['57']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <div class="input-group">
                    ...
                    <el-select :clearable="true"
                        ...
                        placeholder="请选择">
                        <el-option v-for="item in dictionary['69']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
        ...
        <div class="view-context"
            ...
            <div class="table-tool">
                ...
                <p>
                    ...
                    <el-button class="btn-info"
                        ...
                        size="small"
                        @click="getExcel"
                        v-if="power['sign-cw-debt-export'].state">导出
                    </el-button>
                </p>
            </div>
            <el-table ref="tableCom"
                ...
                <el-table-column label="合同信息"
                    ...
                    <template slot-scope="scope">
                        <ul class="contract-msglist">
                            ...
                            <li class="code-paper"
                                v-if="scope.row.recordType.value===2">纸质合同编号:<span @click="toLink(scope.row,'cont')">{{scope.row.paperCode|getLabel}}</span></li>
                ...
                <el-table-column min-width="100"
                    label="收付方式">
                    <template slot-scope="scope">
                        <p v-for="(item,index) in scope.row.method"
                            :key="index">{{item}}</p>
                    </template>
                </el-table-column>
                <el-table-column min-width="60"
                ...
                <el-table-column min-width="80"
                    label="金额（元）">
                    <template slot-scope="scope">
                        <p v-for="(item,index) in scope.row.amoutList"
                            :key="index">{{item.amount}}</p>
                    </template>
                </el-table-column>
                <el-table-column min-width="80"
                    label="线上手续费（元）"
                ...
                <el-table-column min-width="80"
                    ...
                    <template slot-scope="scope">
                        ...
                        <span class="text-warning"
                            v-else
                            @click="getErrorMsg(scope.row)">{{scope.row.payStatus|getLabel}}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column fixed="right"
                    ...
                    <template slot-scope="scope">
                       ...
                       scope.row.payStatusValue!==11">开票</el-button>
                        <el-button type="text"
                        ...
                        <div v-if="power['sign-cw-bill-invoice'].state&&scope.row.billStatus&&scope.row.billStatus.value===2">
                            <el-button type="text"
                                @click="btnOpera(scope.row,4)">打印客户联</el-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="作废"
            ...
            <span slot="footer"
                ...
                <el-button size="small"
                    class="btn-info"
                    round
                    @click="layer.show = false">返 回</el-button>
                <el-button size="small"
                    class="btn-info"
                    round
                    type="primary"
    ...
    mounted() {
        this.$nextTick(() => {
            ...
            if (res && res.route === this.$route.path) {
                ...
                // this.$
                this.searchForm.contType = this.searchForm.contType.map(
                    item => {
                        return Number(item);
                    }
                );
    ...
    methods: {
        ...
        getExcel: function() {
            ...
            if (
                ...
                Object.prototype.toString.call(param.timeRange) ===
                    "[object Array]"
            ) {
