  ...
  <div class="view">
    ...
    <ScreeningTop @propResetFormFn="reset" @propQueryFn="getData">
      <div class="content">
        ...
        <div class="input-group">
          <label>部门:</label>
          <el-select :clearable="true" ref="tree" size="small" :loading="Loading" :remote-method="remoteMethod" @visible-change="initDepList" @clear="clearDep" v-model="searchForm.dealAgentStoreName" placeholder="请选择">
