<template>
  <el-table :max-height="tableHeight" class="info-scrollbar" :data="tableDate" style="width: 100%" @row-dblclick='toDetail' border>
    ...
    <el-table-column align="center" label="交易方式" min-width="100">
      <template slot-scope="scope">
    ...
    <el-table-column align="center" label="成交金额(元)" prop="dealPrice" min-width="100">
      <template slot-scope="scope">
    ...
    <el-table-column align="center" label="收佣状态" prop="receiveAmountState.label" min-width="100">
    </el-table-column>

    <el-table-column align="center" label="财务收款" min-width="100">
      <template slot-scope="scope">
    ...
    <el-table-column align="center" label="房源编号" prop="houseinfoCode" min-width="100">
    </el-table-column>

    <el-table-column align="center" label="物业地址" min-width="150" show-overflow-tooltip>
      <template slot-scope="scope">
