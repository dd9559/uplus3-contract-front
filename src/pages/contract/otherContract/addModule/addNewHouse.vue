      ...
      <div class="houseMsg">
        ...
        <div class="form-content">
          ...
          <el-form-item label="户型：" class="form-label" style="width:570px;text-align:right">
            <input v-model="rightAddrCity" maxlength="2" placeholder="请输入" @input="cutAddress('city')" class="dealPrice" style="width:70px" /> 室
            <input v-model="rightAddrArea" maxlength="2" placeholder="请输入" @input="cutAddress('area')" class="dealPrice" style="width:70px" /> 厅
            <input v-model="rightAddrDetail" maxlength="2" placeholder="请输入" @input="cutAddress('detail')" class="dealPrice" style="width:70px" /> 卫
            <input v-model="rightAddrDetail" maxlength="2" placeholder="请输入" @input="cutAddress('detail')" class="dealPrice" style="width:70px" /> 厨
            <input v-model="rightAddrDetail" maxlength="2" placeholder="请输入" @input="cutAddress('detail')" class="dealPrice" style="width:70px" /> 阳台
          </el-form-item>
        </div>
      </div>
      <!-- 客源信息 -->
