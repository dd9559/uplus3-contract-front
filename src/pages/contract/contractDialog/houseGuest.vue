        ...
        <el-dialog :title="title"
            ...
            <div v-if="getDialogType==='house'"
                ...
                <el-form :inline="true"
                    ...
                    <el-form-item>
                        <el-select v-model="BuildingCode"
                            placeholder="楼栋单元"
                            :clearable="true">
                    ...
                    <el-form-item>
                        <el-input v-model="houseKeyword"
                            placeholder="房号/房源编号/房东手机"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <span @click="isAttention">我的关注 <span class="attention"
                                :class="{'attention_':attention>0}"></span></span>
                    </el-form-item>
                    <el-button type="primary"
                        round
                        class="search_btn"
                        @click="inquireHouse">查询</el-button>
                    <el-button round
                        class="search_btn"
                        @click="resetFormFn">清空</el-button>
                    ...
                    <el-table :data="dataList"
                        ...
                        <el-table-column width="40">
                            <template slot-scope="scope">
                                <span class="outSide">
                                    <span class="inLine"
                                        :class="{'inLineBg':selectCode===scope.row.PropertyCode}"></span>
                                </span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="PropertyNo"
                            label="房源编号"
                            width="150"></el-table-column>
                        <el-table-column prop="EstateName"
                            label="楼盘名称"
                            width="150"></el-table-column>
                        <el-table-column label="状态"
                            prop="LStatus"
                            width="60"></el-table-column>
                        <el-table-column prop="FloorNum"
                            label="楼层"
                        ...
                        <el-table-column :label="priceType"
                            width="80">
                            <template slot-scope="scope">
                                {{scope.row.Price}} {{scope.row.TradeInt===3?'元':'万元'}}
                            </template>
                        </el-table-column>
                        <el-table-column prop="DecorateType"
                            label="装修"
                            width="60"
                            :formatter="nullFormatter"></el-table-column>
                        <el-table-column prop="Emp1"
                            label="维护人"></el-table-column>
                    </el-table>
            ...
            <div v-if="getDialogType==='guest'"
                ...
                <el-form :inline="true"
                    ...
                    <div>
                        <el-form-item label="交易:">
                            <el-select style="width:150px"
                                ...
                                <el-option v-for="item in guestTypeList"
                                    :key="item.value"
                                    :label="item.label"
                                    :value="item.value">
                                </el-option>
                    ...
                    <div>
                        <el-button type="primary"
                            round
                            class="search_btn"
                            @click="inquireGuest">查询</el-button>
                        <el-button round
                            class="search_btn"
                            @click="resetFormFn">清空</el-button>
                    </div>
                    ...
                    <el-table :data="dataList"
                        ...
                        <el-table-column width="40">
                            <template slot-scope="scope">
                                <span class="outSide">
                                    <span class="inLine"
                                        :class="{'inLineBg':selectCode===scope.row.InquiryCode}"></span>
                                </span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="CustName"
                            label="姓名"></el-table-column>
                        <el-table-column prop="InquiryNo"
                            label="客源编号"></el-table-column>
                        <el-table-column prop="Trade"
                            label="交易">
                        </el-table-column>
                        <el-table-column label="意向区域"
                            min-width="100">
                            <template slot-scope="scope">
                ...
                <div class="noList"
                    ...
                    <p v-if="clientStatus===3">系统未查询到该客源，您可以<el-button type="text"
                            @click="innerVisible=true">快速添加该客源</el-button>
                    </p>
                </div>
                <!-- <div class="floor_btn">
                ...
                <el-dialog width="30%"
                    ...
                    <el-form :inline="true"
                        ...
                        <el-form-item label="姓名：">
                            <el-input v-model="addclient.name"
                                placeholder="请输入姓名"></el-input>
                        </el-form-item>
                        <el-form-item label="手机号：">
                            <el-input v-model="addclient.mobile"
                                placeholder="请输入手机号"></el-input>
                        </el-form-item>
                        <el-form-item label="交易类型：">
                            <el-select v-model="addclient.tradeType"
                                placeholder=""
                                style="width:150px">
                                <el-option label="求租"
                                    value="1"></el-option>
            ...
            this.$ajax
                ...
                .then(res => {
                    ...
                    if (res.status === 200) {
                        ...
                        //   }
                        // });
                        this.EmployeList = this.EmployeList.concat(
                            res.data.list
                        );
