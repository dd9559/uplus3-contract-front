  ...
  <div class="view-container" id="adjustcheck" ref="tableComView">
    ...
    <div class="contract-list">
      <el-table :data="tableData.list" ref="tableCom" :max-height="tableNumberCom" style="width: 100%" v-loading="loadingTable" @row-dblclick='toDetail' border>
        ...
        <el-table-column label="签约方式" min-width="80">
          <template slot-scope="scope">
            {{scope.row.recordType===2?'线下':'线上'}}
          </template>
        </el-table-column>
        <el-table-column label="成交总价" :formatter="nullFormatter" min-width="90" prop="dealPrice">
          <template slot-scope="scope">
        ...
        <el-table-column label="成交经纪人" :formatter="nullFormatter" min-width="120">
          <template slot-scope="scope">
        ...
        <el-table-column label="审核状态" :formatter="nullFormatter" min-width="80">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" min-width="120" fixed="right" class-name="null-formatter">
          <template slot-scope="scope">
            ...
            <div class="btn" @click="auditApply(scope.row)" v-if="scope.row.checkState === 0 && ((cope.row.checkby === getUserMsg.empId)||((!(cope.row.checkby>0))&&scope.row.grabDept&&scope.row.grabDept.indexOf(String(getUserMsg.depId))>-1))">审核</div>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
