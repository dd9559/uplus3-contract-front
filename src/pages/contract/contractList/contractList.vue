    ...
    <div class="view-container"
        ...
        <ScreeningTop @propQueryFn="queryFn"
            ...
            <el-form :inline="true"
                ...
                <el-form-item label="成交报告"
                    v-if="contVersion===2">
                    <el-select v-model="contractForm.reportRecord"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option label="已录"
                ...
                <el-form-item label="用途">
                    <el-select v-model="contractForm.housePurpose"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option v-for="item in housePurpose"
                            :key="item.key"
                            :label="item.value"
                            :value="item.value">
                        </el-option>
                ...
                <el-form-item label="签后审核状态">
                    <el-select v-model="contractForm.signinState"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option v-for="item in dictionary['72']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <el-form-item label="结算状态"
                    v-if="contVersion===2">
                    <el-select v-model="contractForm.resultState"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option v-for="item in dictionary['14']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <el-form-item label="收佣状态">
                    <el-select v-model="contractForm.receiveAmountState"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                ...
                <el-form-item label="业绩状态">
                    <el-select v-model="contractForm.achievementState"
                        placeholder="全部"
                        :clearable="true"
                        style="width:150px">
                        <el-option v-for="item in dictionary['54']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
                ...
                <el-form-item label="后期状态"
                    v-if="contVersion===2">
                    <el-select v-model="contractForm.laterStageState"
                        placeholder="全部"
                        :clearable="true">
                        <el-option v-for="item in dictionary['11']"
                            :key="item.key"
                            :label="item.value"
                            :value="item.key">
                        </el-option>
        ...
        <div class="contract-list">
                ...
                <div>
                    <div class="haveSon"
                        ...
                        <div class="holderPlace"
                            v-if="dictionary['71']">
                            <ul class="mainList">
                                <li v-for="item in dictionary['71']"
                                    :key="item.key"
                                    ...
                                    <i class="el-icon-caret-right"
                                        ...
                                        style="position:absolute;top:10px;left:55px;"></i>
                                    <div class="childrenModule"
                                        v-if="item.key===2&&item.children">
                                        <ul class="childrenList">
                                            <li v-for="item_ in item.children"
                                                :key="item_.key"
                                                @click="addOnLine(item_)">{{item_.value}}</li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="haveSon"
                        ...
                        <div class="holderPlace"
                            v-if="dictionary['65']">
                            <ul class="mainList">
                                <li v-for="item in dictionary['65']"
                                    :key="item.key"
                                    ...
                                    <div class="childrenModule"
                                        ...
                                        <ul class="childrenList">
                                            <li v-for="item_ in item.children"
                                                :key="item_.key"
                                                @click="addOffLine(item_)">{{item_.value}}</li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <li v-for="item in dictionary['71']"
                                    ...
                                    <div class="childrenModule"
                                        ...
                                        <ul class="childrenList">
                                            <li v-for="item_ in item.children"
                                                :key="item_.key"
                                                @click="printCont(item_)">{{item_.value}}</li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
            ...
            <el-table :span-method="objectSpanMethod"
                    ...
                    <template slot-scope="scope">
                        <div class="contract_msg">
                            ...
                            <ul class="contract-msglist">
                                <li>合同：<span class="blueColor"
                                        @click="toDetail(scope.row)">{{scope.row.code}}</span></li>
                                <li v-if="scope.row.recordType.value===2">纸质合同编号：<span class="blueColor"
                                        @click="toDetail(scope.row)">{{scope.row.pCode}}</span></li>
                ...
                <el-table-column label="财务收付"
                    min-width="80">
                    <template slot-scope="scope">
                        <div v-if="!scope.row.isCombine">
                            <div class="btn"
                                @click="runningWater(scope.row)">流水</div>
                            <div class="btn" v-if="!scope.row.isTransaction"
                                @click="gathering(scope.row)">收款</div>
                            <div class="btn"
                                @click="payment(scope.row)">付款</div>
                        </div>
                        <div class="btn" v-else-if="!scope.row.isTransaction"
                                @click="gathering(scope.row)">收款</div>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="签后审核状态"
                    ...
                    <template slot-scope="scope">
                        <div v-if="scope.row.signingState">
                            <span v-if="scope.row.signingState.value===-1"
                                class="blue">{{scope.row.signingState.label}}</span>
                            <span v-if="scope.row.signingState.value===0"
                                class="yellow">{{scope.row.signingState.label}}</span>
                            <span v-if="scope.row.signingState.value===1"
                                class="green">{{scope.row.signingState.label}}</span>
                            ...
                            <span v-if="scope.row.signingState.value===2&&!scope.row.signingRemarks"
                                class="red">{{scope.row.signingState.label}}</span>
                        </div>
                        <div v-else
                            class="blue">待提审</div>
                    </template>
                ...
                <el-table-column label="后期状态"
                    ...
                    <template slot-scope="scope">
                        <span v-if="scope.row.contType.value<4&&scope.row.contType.value!==1&&!scope.row.isCombine">
                            ...
                            <el-button v-if="scope.row.laterStageState&&scope.row.laterStageState.label==='已拒绝'"
                                type="text"
                                size="medium">已拒绝</el-button>
                            <span v-else>{{scope.row.laterStageState?scope.row.laterStageState.label:'-'}}</span>
                        </span>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
                <el-table-column label="后期进度"
                    min-width="80"
                    v-if="contVersion===2"
                    ...
                    <template slot-scope="scope">
                        <span v-if="scope.row.contType.value<4&&!scope.row.isCombine">
                            ...
                            <el-tooltip class="item"
                                ...
                                placement="top">
                                <span class="stepInstanceName"
                                    @click="showStepInstance(scope.row)">{{scope.row.stepInstanceName}}</span>
                            </el-tooltip>
                        </span>
                        <span v-else>-</span>
                    </template>
                ...
                <el-table-column label="实收/应收"
                    ...
                    <template slot-scope="scope">
                        <div class="btn"
                            ...
                            v-if="scope.row.contType.value<4">{{scope.row.receivedCommission}}/{{scope.row.receivableCommission}}</div>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="打印次数">
                    <template slot-scope="scope">
                        <el-button type="text"
                            ...
                            v-if="scope.row.printCount>0">{{scope.row.printCount}}</el-button>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
                    ...
                    <template slot-scope="scope">
                        <template v-if="!scope.row.isCombine&&scope.row.contState.value!=-1">
                            ...
                            <div class="btn"
                                ...
                                @click="goSave(scope.row,'cont')">合同提审</div>
                            <div class="btn"
                                v-if="power['sign-ht-qhsh-toverify'].state&&scope.row.signAudit"
                                @click="toSignAudit(scope.row,'sign')">签后提审</div>
                            <div class="btn"
                                ...
                                @click="toLayerAudit(scope.row)">调佣</div>
                            <div class="btn"
                                v-if="scope.row.contState.value==1&&power['sign-ht-info-del'].state"
                                @click="showDelete(scope.row)">删除</div>
                            <div v-if="(scope.row.contType.value==4||scope.row.contType.value==5)&&scope.row.contState.value===3 && !scope.row.isDeal"
                                class="btn"
                                @click="toDeal(scope.row)">转成交</div>
                        </template><template v-if="scope.row.isCombine&&scope.row.contState.value!=-1">
                            <div class="btn"
                                v-if="power['sign-ht-info-view'].state&&scope.row.recordType.value===1"
                                @click="goPreview(scope.row)">预览</div>
                            <div class="btn"
                            ...
                            <div class="btn"
                                v-if="power['sign-ht-qhsh-toverify'].state&&scope.row.signAudit"
                                @click="toSignAudit(scope.row,'sign')">签后提审</div>
                        </template><template v-if="scope.row.contState.value===-1">
                            <div class="btn"
                                @click="deleteCont(scope.row,1)"
                                v-if="power['sign-ht-info-recovery'].state&&!scope.row.isCombine">恢复</div>
                        </template>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <!-- 调佣弹框 -->
        <layerAudit :dialogVisible="tiaoyong"
            :layerAudit="layerAudit"
            @closeCentCommission="closeCommission"
            v-if='tiaoyong'></layerAudit>
        <!-- 结算弹窗 -->
        <layerSettle :settleDialog="jiesuan"
            :contId="settleId"
            :layerAudit="layerSettle"
            @closeSettle="closeSettle"
            v-if='settleId'></layerSettle>
        <!-- 变更/解约查看 合同主体上传弹窗 -->
        ...
        <!-- 后期进度查看 -->
        <lateProgress title="查看交易流程"
            ref="lateProgress"></lateProgress>
        <!-- 提审确认框 -->
        <el-dialog title="提示"
            ...
            <span slot="footer"
                class="dialog-footer">
                <el-button round
                    @click="isSubmitAudit = false">取 消</el-button>
                <el-button round
                    type="primary"
                    @click="toAudit">确 定</el-button>
            </span>
        </el-dialog>
        <!-- 打印详情弹窗 -->
        <el-dialog title="打印详情"
            :visible.sync="isHavePrint"
            width="460px">
            <div>
        ...
        <el-dialog title="确认删除"
            ...
            <span slot="footer"
                ...
                <el-button round
                    type="primary"
                    @click="deleteCont(deleteItem,0)">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getContractList(type = "init") {
            ...
            this.$ajax
                .postJSON("/api/contract/contractList", param)
                .then(res => {
                    res = res.data;
                    if (res.status === 200) {
                        this.tableData = res.data.list;
            ...
            this.$ajax
                ...
                .catch(error => {
                    ...
                    if (error.message === "下一节点审批人不存在") {
                        ...
                        this.checkPerson.flowType = this.submitAuditData
                            .isCombine
                            ? 11
                            : 3;
        ...
        combineList() {
            ...
            this.tableData.forEach((element, index) => {
                if (element.contractEntrust && element.contractEntrust.id) {
                    ...
                    combineItem.printCount =
                        combineItem.contractEntrust.printCount; //打印次数
                    combineItem.distributableAchievement =
                        combineItem.contractEntrust.tradeFeeCommission; //可分配业绩
                    combineItem.receivableCommission = combineItem
                        .contractEntrust.receivableCommission
                    ...
                    if (combineItem.signingEntrustRemarks) {
                        combineItem.signingRemarks =
                            combineItem.signingEntrustRemarks;
                    } else {
                        combineItem.signingRemarks = "";
                    }
                    ...
                    combineItem.isCanAudit = combineItem.contractEntrust
                        ...
                        : 0; //H5是否填写完整
                    combineItem.signAudit = combineItem.contractEntrust
                        .entrustSignAudit
