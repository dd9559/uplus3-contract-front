  ...
  <div class="view-container" ref="tableComView">
    ...
    <div class="contract-list">
      ...
      <el-table ref="tableCom" class="info-scrollbar" :data="tableData" border style="width: 100%"  @row-dblclick='toDetail' :max-height="tableNumberCom">
        ...
        <el-table-column align="center" label="合同类型" prop="contType.label" width="60" fixed>
        </el-table-column>
        <el-table-column align="center" label="物业地址" prop="propertyAddr" min-width="160" fixed>
        </el-table-column>
        <el-table-column align="center" label="成交总价" prop="dealPrice" width="90" fixed>
          <template slot-scope="scope">
        ...
        <el-table-column align="center" label="操作" width="120">
          <template slot-scope="scope">
            ...
            <el-button type="text"  v-if="scope.row.toExamineState.value===0&&((scope.row.contType.value===1&&userMsg&&scope.row.auditId===userMsg.empId)||((scope.row.contType.value===2||scope.row.contType.value===3)&&scope.row.auditId<0&&userMsg&&(userMsg.roleId===22||userMsg.roleId===23)))" @click="goCheck(scope.row)">审核</el-button>
            <!-- </div> -->
          </template>
        </el-table-column>
      </el-table>
