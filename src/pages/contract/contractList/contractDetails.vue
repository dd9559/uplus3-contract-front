    ...
    <div class="view-container">
            ...
            <el-tabs v-model="activeName"
                ...
                <el-tab-pane label="合同详情"
                    ...
                    <div class="firstDetail"
                        ...
                        <div class="msg">
                            ...
                            <div class="content">
                                <div class="one_">
                                    ...
                                    <p style="position:relative;"
                                        v-if="contractDetail.recordType.value===2">
                                    ...
                                    <p>
                                        ...
                                        <span class="text"
                                            v-if="contractDetail.contType.value===1">租赁</span>
                                        <span class="text"
                                            v-if="contractDetail.contType.value===2&&!contractDetail.loanType">买卖</span>
                                        <span class="text"
                                            v-if="contractDetail.contType.value===2&&contractDetail.loanType">{{contractDetail.loanType===7?"全款买卖":"贷款买卖"}}</span>
                                        <span class="text"
                                            v-if="contractDetail.contType.value===3">代办</span>
                                        <span class="text"
                                            v-if="contractDetail.contType.value===4">意向</span>
                                        <span class="text"
                                            v-if="contractDetail.contType.value===5">定金</span>
                                    </p>
                                    <p style="width:530px">
                                        <span class="tag">{{contractDetail.contType.value===1?'租金：':'成交总价：'}}</span>
                                        <span class="dealPrice">{{contractDetail.dealPrice}} 元
                                            <i v-for="item in dictionary['507']"
                                                :key="item.key"
                                                v-if="item.key===contractDetail.timeUnit&&contractDetail.contType.value===1"> / {{item.value}}</i>
                                    ...
                                    <el-table :data="ownerData"
                                        ...
                                        <el-table-column label="电话">
                                            <template slot-scope="scope">
                                                {{scope.row.mobile}}
                                                <i class="iconfont icon-tubiao_shiyong-16"
                                                    @click="call(scope.row,scope.$index,'owner')"
                                                    v-if="power['sign-ht-xq-ly-call'].state"></i>
                                            </template>
                                        </el-table-column>
                                        <el-table-column prop="relation"
                                            label="关系"></el-table-column>
                        ...
                        <div class="msg"
                            v-if="contractDetail.isHaveCooperation">
                                ...
                                <div class="one_">
                                    ...
                                    <p>
                                        ...
                                        <span class="text"
                                            ...
                                            :key="item.key"
                                            v-if='item.key===contractDetail.otherCooperationInfo.type'>{{item.value}}</span>
                                        <span class="text"
                                            v-else>--</span>
                                    </p>
                                </div>
                        ...
                        <div class="msg">
                            ...
                            <div class="content">
                                ...
                                <div class="table"
                                    style="width:1300px;">
                                    <el-table :data="employeeData.houseAgents"
                                        border
                                        header-row-class-name="theader-bg"
                                        key="house">
                      ...
                      <template slot-scope="scope">
                        {{scope.row.salesManagerLevel?scope.row.salesManagerLevel:'-'}}
                                ...
                                <div class="table"
                                    ...
                                    <el-table :data="employeeData.customerAgents"
                                        border
                                        header-row-class-name="theader-bg"
                                        key="customer">
                                        <el-table-column label="角色类型">
                      ...
                      <template slot-scope="scope">
                        {{scope.row.salesManagerLevel?scope.row.salesManagerLevel:'-'}}
                                ...
                                <div class="table"
                                    ...
                                    <el-table :data="employeeData.serviceAgents"
                                        border
                                        header-row-class-name="theader-bg"
                                        key="service">
                                        <el-table-column label="角色类型">
                    ...
                    <div class="footer">
                        ...
                        <div v-if="contractDetail.contChangeState.value!=2">
                            ...
                            <el-button round
                                type="primary"
                                class="search_btn"
                                v-if="(power['sign-ht-info-edit'].state&&contractDetail.recordType.value===1&&contractDetail.contState.value!=3)||(power['sign-ht-info-addoffline'].state&&contractDetail.recordType.value===2&&(contractDetail.contState.value!=3||contractDetail.contState.value===3&&contractDetail.resultState.value===1&&!getUserMsg))"
                    ...
                    <div class="contractSubject"
                        ...
                        <ul class="ulData"
                            ...
                            <li v-for="(item,index) in uploadList"
                                ...
                                <i v-if="(contractDetail.signingState&&contractDetail.signingState.value!==1&&contractDetail.signingState.value!==0)||!contractDetail.signingState"
                        ...
                        <el-button type="primary"
                            ...
                            class="search_btn"
                            @click="saveFile('main')"
                            v-if="power['sign-ht-xq-main-add'].state&&((contractDetail.signingState&&contractDetail.signingState.value!==1&&contractDetail.signingState.value!==0)||!contractDetail.signingState)&&(contractDetail.contState.value>1||(contractDetail.recordType.value===2&&contractDetail.contState.value!=0))">确认上传</el-button> <!-- 合同主体上传 -->
                    </div>
                    <div class="contractSubject"
                        ...
                        <ul class="ulData"
                            style="margin-bottom:10px">
                            <li v-show="(contractDetail.signingEntrustState&&contractDetail.signingEntrustState.value!==1&&contractDetail.signingEntrustState.value!==0)||!contractDetail.signingEntrustState">
                                <file-up class="uploadSubject"
                            ...
                            <li v-for="(item,index) in entrustUploadList"
                                :key="item.index"
                                @mouseover="moveIn(item.index+item.path)"
                                @mouseout="moveOut(item.index+item.path)">
                                <el-tooltip class="item"
                                    ...
                                    placement="bottom">
                                    <div class="namePath"
                                        @click="previewPhoto(entrustUploadList,index,2)">
                                        <img class="signImage"
                                ...
                                <i v-if="(contractDetail.signingEntrustState&&contractDetail.signingEntrustState.value!==1&&contractDetail.signingEntrustState.value!==0)||!contractDetail.signingEntrustState"
                                    class="iconfont icon-tubiao-6"
                ...
                <el-tab-pane label="资料库"
                    ...
                    <div class="dataBank"
                                ...
                                <ul class="ulData">
                                    ...
                                    <li v-for="(item_,index_) in item.value"
                                        ...
                                        <el-tooltip class="item"
                                            ...
                                            placement="bottom">
                                            <div class="namePath"
                                                @click="previewPhoto(item.value,index_,3)">
                                                <img class="signImage"
                        ...
                        <div class="classifyFoot"
                            v-if="contractDetail.laterStageState.value===4">
                            <p class="objection">拒绝理由: {{contractDetail.refuseReasons}}</p>
                        </div>
                        <div class="accessoryDown"
                ...
                <el-tab-pane label="委托合同"
                    v-if="(contType==='2'||contType==='3')&&power['sign-ht-xq-entrust-edit'].state"
                    name="agency">
                    <agency-contract :defaultInfo="contractDetail"
                        v-if="agencyShow&&isHaveDetail"
                        @goToMainData="goToMainData"></agency-contract>
                </el-tab-pane>

                <el-tab-pane label="应收实收"
                    name="receipt"
                    v-if="power['sign-ht-xq-ys-qurey'].state">
                    <div class="receiptModule">
                        <div class="moduleTitle">
                            ...
                            <el-button round
                                ...
                                v-if="power['sign-ht-xq-ys-add'].state">新增</el-button>
                        </div>
                        <div class="receiptList">
                            <el-table :data="supposedList"
                                border
                                style="width: 100%"
                                ...
                                <el-table-column label="款类"
                                    prop="moneyName"
                                    min-width="50"
                                    show-overflow-tooltip>
                                </el-table-column>
                                <el-table-column label="应收/应付金额（元）"
                                    prop="amount"
                                    min-width="50">
                                </el-table-column>
                                <el-table-column label="收付方式"
                                    prop="payment"
                                    min-width="40">
                                </el-table-column>
                                ...
                                <el-table-column label="操作"
                                    ...
                                    <template slot-scope="scope">
                                        <div v-if="scope.row.operation!=1">
                                            <span class="receipBtn"
                                                v-if="power['sign-ht-xq-ys-add'].state"
                                                @click="receiptEdit('supposed',scope.row.payId)">编辑</span>
                                            <span class="receipBtn"
                                                v-if="power['sign-ht-xq-ys-del'].state"
                                                @click="receiptDel(scope.row.payId,'supposed')">删除</span>
                            ...
                            <el-pagination v-if="supposedList.length>0"
                    ...
                    <div class="receiptModule">
                        <div class="moduleTitle">
                            ...
                            <el-button round
                                ...
                                size="small"
                                v-if="power['sign-ht-xq-ys-add'].state"
                                @click="receiptAdd('actual')">新增</el-button>
                        </div>
                        <div class="receiptList">
                            <el-table :data="actualList"
                                ...
                                <el-table-column label="实收/实付金额（元）"
                                    prop="amount"
                                    min-width="50">
                                </el-table-column>
                                <el-table-column label="收付方式"
                                ...
                                <el-table-column label="操作"
                                    ...
                                    <template slot-scope="scope">
                                        <div v-if="scope.row.operation!=1">
                                            <span class="receipBtn"
                                                v-if="power['sign-ht-xq-ys-add'].state"
                                                @click="receiptEdit('actual',scope.row.payId)">编辑</span>
                                            <span class="receipBtn"
                                                v-if="power['sign-ht-xq-ys-del'].state"
                                                @click="receiptDel(scope.row.payId,'actual')">删除</span>
                                            <span v-if="!power['sign-ht-xq-ys-add'].state&&!power['sign-ht-xq-ys-del'].state">-</span>
                                        </div>
                                        <span v-else>-</span>
                                    </template>
                            ...
                            <el-pagination v-if="actualList.length>0"
                                class="pagination-info"
                ...
                <el-tab-pane label="回访录音"
                    name="fourth">
                    <div class="type">
                        <div :class="{'active':isActive===1}"
                            @click="changeType(1)">房源</div>
                        <div :class="{'active':isActive===2}"
                            @click="changeType(2)">客源</div>
                    </div>
                    <div class="record">
                        <el-table :data="recordData"
                            ...
                            <el-table-column prop="recording"
                                label="录音"
                                width="200">
                                <template slot-scope="scope">
                                    <div class="recordPlay"
                                        ...
                                        <span class="playBtn"
                                            @click="playStop(scope.$index,scope.row)">
                                            <i class="iconfont"
                                                :class="[(recordKey===scope.$index)&&isPlay&&!isReady?'icon-tubiao_shiyong-19':'icon-tubiao_shiyong-17',isReady?'icon-loading':'icon-tubiao_shiyong-17']"></i>
                                        </span>
                                        <span class="duration">
                                            ...
                                            <el-progress :show-text="false"
                                                :percentage="scope.row.recordTime"></el-progress>
                                        </span>
                                    </div>
                                    <span v-else>--</span>
                                    <audio :src="scope.row.recordSrc"
                                        :id="'audio'+scope.$index"></audio>
                                </template>
                            </el-table-column>
                            <el-table-column label="备注"
                                width="320">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.remarks">
                                        ...
                                        <div v-else
                                            class="noPower"><i class="iconfont icon-tubiao_shiyong-12"></i> 无权限浏览</div>
                                    </div>
                                    <p v-else
                                        class="iconfont icon-tubiao_shiyong-14 addRemarks"
                                        @click="showRemark(scope.row)"> 添加备注</p>
                                </template>
                            </el-table-column>
                        </el-table>
                        <el-pagination v-if="recordData.length>0"
                            class="pagination-info"
        ...
        <div class="functionTable">
            <el-button round
                ...
                @click="runningWater">合同流水</el-button>
            <el-button round
                v-if="power['sign-ht-info-edit'].state&&name==='deal-report'&&editBtnShow"
                style="background:#478DE3;color:white;"
                @click="editFn">编辑</el-button>
            <el-button round
                class="search_btn"
                v-if="power['sign-ht-xq-print'].state&&name==='deal-report'&&reportBtnShow"
                @click="printDemo">打印成交报告</el-button>
            <el-button type="primary"
                round
                class="search_btn"
                @click="fencheng"
                v-if="power['sign-ht-xq-yj'].state&&name==='first'&&contractDetail.contState.value===3&&contractDetail.achievementState.value===-2">分成</el-button>
        </div>
        <div class="uploadBtn">
            <el-button type="primary"
                round
                ...
                v-if="power['sign-ht-xq-data'].state&&name==='third'&&((contractDetail.signingState&&contractDetail.signingState.value!==1&&contractDetail.signingState.value!==0)||!contractDetail.signingState)">{{contractDetail.laterStageState.value===4?'提交审核':'确认上传'}}</el-button> <!-- 合同资料库上传 -->
        </div>
        ...
        <el-dialog title="添加备注"
            ...
            <span slot="footer"
                class="dialog-footer">
                <el-button round
                    @click="showRemarks = false">取消</el-button>
                <el-button round
                    type="primary"
                    @click="addRemark">保存</el-button>
            </span>
        </el-dialog>
        <!-- 提审弹窗 -->
        <el-dialog title="提示"
        ...
        <!-- 审核，编辑，反审核，业绩分成弹框 -->
        <achDialog :shows="shows"
            @close="closeAch"
            :achObj="achObj"
            :dialogType="dialogType"
            :contractCode="code2"></achDialog>
        <!-- 变更/解约编辑弹窗 -->
        ...
        <!-- 流水明细弹框 -->
        <flowAccount :dialogTableVisible="water"
            :contCode="contCode"
            :contId="waterId"
            @closeRunningWater="closeWater"
            v-if="water"></flowAccount>
        <!-- 线下合同提示上传资料库弹窗 -->
        <el-dialog title="提示"
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                    @click="toUpload">完善资料库</el-button>
            </span>
        </el-dialog>
        <!-- 应收实收弹窗 -->
        <billDialog :dialog-show="dialogState"
        ...
        <el-dialog title="提示"
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                    @click="delBillMsg">确 定</el-button>
            </span>
        </el-dialog>
        <!-- 打印成交报告 -->
            ...
            <div class="printContent"
                ...
                <div class="resource">
                    <div class="guest">
                        ...
                        <div>
                            <p><span>门店：</span><span>{{contractDetail.report.guestStoreName}}</span></p>
                        </div>
                    </div>
                    <div class="house">
                        ...
                        <div>
                            <p><span>门店：</span><span>{{contractDetail.report.houseStoreName}}</span></p>
                        </div>
                    </div>
                </div>
                <div class="mai-mai resource">
                    <div class="guest">
                        <div class="title"
                            style="border-bottom: 1px solid #ebeef5;">买方信息</div>
                        <div>
                    ...
                    <div class="seller">
                        <div class="title"
                            style="border-bottom: 1px solid #ebeef5;">卖方信息</div>
                        <div>
                        ...
                        <div class="no-bottom display-b"
                            v-for="(item,index) in sellerInfo"
                            :key="index">
                            <div>
                                <p><span style="min-width:84px;">共有人姓名：</span><span>{{item.name}}</span></p>
                            </div>
                ...
                <div class="resource">
                    <div class="guest">
                        ...
                        <div>
                            <p><span>电话：</span><span>{{contractDetail.report.buyerAgentMobile?contractDetail.report.buyerAgentMobile:'--'}}</span></p>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <p><span>电话：</span><span>{{contractDetail.report.sellerAgentMobile?contractDetail.report.sellerAgentMobile:'--'}}</span></p>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        goEdit() {
            ...
            this.$router.push({
                ...
                query: {
                    ...
                    type: this.contType,
                    isOffline:
                        this.contractDetail.recordType.value === 2 ? 1 : 2
                }
            });
        },
        //提审
                ...
                .then(res => {
                    ...
                    if (res.status === 200) {
                        ...
                        this.contractDetail.report = res.data.dealReport
                            ...
                            : {};
                        if (
                            JSON.stringify(this.contractDetail.report) !== "{}"
                        ) {
                            marriage.forEach(item => {
                                if (
                                    this.contractDetail.report.maritalStatus ===
                                    item.id
                                ) {
                                    this.contractDetail.report.maritalStatus =
                                        item.type;
                        ...
                        this.contractDetail.signDate = res.data.signDate.substr(
                            0,
                            16
                        );
                        this.ownerData = [];
                        ...
                        for (
                            var i = 0;
                            i < this.contractDetail.contPersons.length;
                            i++
                        ) {
                            if (
                                this.contractDetail.contPersons[i].personType
                                    .value === 1
                            ) {
                                this.ownerData.push(
                                    this.contractDetail.contPersons[i]
                                );
                            } else if (
                                this.contractDetail.contPersons[i].personType
                                    .value === 2
                            ) {
                                this.clientrData.push(
                                    this.contractDetail.contPersons[i]
                                );
                            }
                        }
                        ...
                        if (res.status === 200) {
                            ...
                            if (type === "main") {
                                ...
                                if (
                                        ...
                                        onClose() {
                                            let newPage = that.$router.resolve({
                                                ...
                                                query: {
                                                    ...
                                                    contractId:
                                                        that.contractDetail.id,
                                                    version:
                                                        that.getUser.version,
                                                    contType:
                                                        that.contractDetail
                                                            .contType.value
                                                }
                                    ...
                                    //提示上传资料库
                                    if (
                                        this.contractDetail.recordType.value ===
                                            2 &&
        ...
        getSupposedList() {
            ...
            this.$ajax
                .get("/api/receivables/listRceivables", param)
                .then(res => {
                    res = res.data;
                    if (res.status === 200) {
