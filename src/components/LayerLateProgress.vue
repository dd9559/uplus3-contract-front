        ...
        <el-dialog :title="getTitle"
            ...
            <LayerScrollAuto>
                <div class="layer-progress">
                    ...
                    <el-table border
                        ...
                        <el-table-column label="操作"
                            ...
                            align="center">
                            <template slot-scope="scope">
                                <el-button v-if="operationBoolFn(scope.row)"
                ...
                <div class="evaluation">
                    <p class="p1">评价信息：</p>
                    <ul class="ul">
                        <li class="li"><em class="cl-999">付款方式：</em>贷款</li>
                        <li><em class="cl-999">后期步骤：</em>合同签署</li>
                    </ul>
                    <ul class="ul">
                        <li class="li">
                            <em class="cl-999">客户姓名：</em>
                            <span>*****</span>
                            <i class="el-icon-view"
                                @click="eyeClickFn"></i>
                        </li>
                        <li><em class="cl-999">客服：</em>吉家-薇薇安(202008092402)</li>
                    </ul>
                    <div class="p2">
                    ...
                    <div class="p3">评价内容评价内容评价内容评价内容评价内容评价。</div>
                </div>
            </LayerScrollAuto>
        </el-dialog>
        <!-- 查看 -->
        <el-dialog :close-on-click-modal="$tool.closeOnClickModal"
            :close-on-press-escape="$tool.closeOnClickModal"
            title="查看"
