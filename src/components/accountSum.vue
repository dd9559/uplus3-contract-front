    ...
    <div class="view-container" ref="tableComView">
        ...
        <div class="view-context">
            <div class="table-tool">
                ...
                <p>
                    <el-button class="btn-info" style="background-color: #38BD8B; color: white;" size="small" @click="getExcel" v-dbClick v-if="power['sign-book-hz-export'].state">导出</el-button>
                </p>
            </div>
