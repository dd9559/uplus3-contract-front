...
let sub = {
  info_val5: {
    stateful: function(index) {
      return document.querySelector("*[extendparam=val5]").innerHTML !== ""
        ? { val6: null }
        : null;
    }
  },
  info_val11: {
    stateful: function(index) {
      return document.querySelector("*[extendparam=val11]").innerHTML !== ""
        ? { val12: null }
        : null;
    }
  },
  ...
  info_val20: {
    stateful: function(index) {
      return document.querySelector("*[extendparam=val20]").innerHTML !== ""
        ? { val21: null }
        : null;
    }
  },
        ...
        ? {
            drapdown_val23: {
              stateful: function(index1) {
                return index1 === "①"
                  ? { time_val24: null, val25: null }
                  : { time_val26: null, val27: null, val28: null };
              }
            }
          }
  ...
  drapdown_val36: {
    stateful: function(index) {
      return index === "(3)"
        ? { time_val37: null, val38: null, val39: null, val40: null }
        : null;
    }
  },
  val41: null,
    ...
    function(obj, index) {
      ...
      if (attr === "four") {
        ...
        for (let i = 0; i < bodyItem.length; i++) {
          ...
          if (element.tagName.toLocaleLowerCase() === "div") {
            if (
              bodyCheckboxs.indexOf(
                "checkbox_" + element.getAttribute("name")
              ) === -1
            ) {
            ...
            if (
              bodyInputs.indexOf(element.getAttribute("extendparam")) === -1
            ) {
