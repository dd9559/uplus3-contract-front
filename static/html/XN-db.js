...
for (let readonlyItem in msg) {
  ...
  let readonlyArr = ['code', 'lepName', 'ownerName', 'ownerID', 'guestTel', 'ownerNames', 'signDate', 'subscriptionPriceUpper', 'subscriptionPrice', 'ownerIDs', 'guestName', 'guestID', 'guestNames', 'guestIDs', 'propertyAddr', 'dealPrice', 'dealPriceUpper', 'companyNames', 'guestStoreRegisterCode']
      ...
      if (readonlyArr.includes(readonlyItem)) {
        if (readonlyItem === 'companyNames') {
          ...
          if (msg[readonlyItem]) {
            ...
            document.querySelector(`*[extendparam=val100]`).classList.add('input-before')
            document.querySelector(`*[extendparam=val100]`).removeAttribute('systemParam')
          }
